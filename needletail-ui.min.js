...
class GroupedSearchBar extends BaseClasses_1.Widget {
    ...
    renderResultTemplates(options = {}, template = null) {
        let use = (template) ? template : grouped_search_bar_results_default_html_1.default;
