...
class AutocompleteBar extends BaseClasses_1.Widget {
    constructor(options = {}) {
        ...
        this.debounce = (typeof Helpers_1.optional(options.debounce).use !== 'undefined') ? options.debounce.use : this.debounce;
        ...
        this.buckets = Helpers_1.optional(options.search).buckets || '';
    ...
    setForceUseOfResult(force_use_of_result) {
        ...
        document.querySelectorAll(`${this.getEl()} .needletail-autocomplete-bar-input`).forEach((element) => {
            ...
            element.addEventListener('keydown', (e) => {
                if (e.key === 'ArrowUp' || e.key === 'ArrowDown') {
                    let results = document.querySelectorAll(`${this.getEl()} .needletail-autocomplete-bar-result`);
                    if (e.key === 'ArrowUp') {
        ...
        document.addEventListener(Helpers_1.Events.onSearch, (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result && result.data.count > 0) {
                e.detail.search_result = result.data.results.map((r) => {
                    let mapped = Object.assign(Object.assign({}, r.record), { value: r.record[this.attribute.replace('.autocomplete', '')], raw: r.record[this.attribute.replace('.autocomplete', '')] });
                    if (r.highlight) {
    ...
    buildResults(options = {}) {
        ...
        document.querySelectorAll(`.needletail-autocomplete-bar-${this.getQuery()}`).forEach((element) => {
            ...
            let input = element.querySelector('.needletail-autocomplete-bar-input');
...
// Module
var code = "<div class=\"needletail-autocomplete-bar-results\"> {{#initial_input}} <div class=\"needletail-autocomplete-bar-result needletail-initial-input\" data-attribute=\"{{initial_input}}\"> {{{initial_input}}} </div> {{/initial_input}} {{#results}} <div class=\"needletail-autocomplete-bar-result\" data-attribute=\"{{raw}}\"> {{{title}}} <hr> {{{highlight}}} </div> {{/results}} {{^results}} <div class=\"needletail-autocomplete-bar-no-result\"> {{{no_result_message}}} </div> {{/results}} </div>";
// Exports
module.exports = code;
...
const grouped_search_bar_results_default_html_1 = __importDefault(__webpack_require__(44));
const mustache_1 = __importDefault(__webpack_require__(1));
const debounce_1 = __importDefault(__webpack_require__(3));
const Helpers_1 = __webpack_require__(2);
class GroupedSearchBar extends BaseClasses_1.Widget {
    ...
    executeJS() {
        ...
        document.querySelectorAll(`${this.getEl()} .needletail-grouped-search-bar-input`).forEach((element) => {
            ...
            element.addEventListener('keydown', (e) => {
                if (e.key === 'ArrowUp' || e.key === 'ArrowDown') {
                    let results = document.querySelectorAll(`${this.getEl()} .needletail-grouped-search-bar-result`);
                    if (e.key === 'ArrowUp') {
                        // Move the active class up one
                        if (this.selectedResult > 0) {
                            this.selectedResult--;
        ...
        document.addEventListener(Helpers_1.Events.onGroupedSearch, (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.buckets.forEach((val) => {
                if (typeof val === "object") {
                    if (val.name) {
                        let attributes = val.attribute || this.attribute;
                        if (typeof attributes === "string") {
                            attributes = [attributes];
                        }
                        let search = [];
            ...
            if (result && result.data) {
                ...
                Object.keys(result.data).forEach((bucketKey) => {
                    ...
                    let bucket = this.buckets.find((b) => b.name === bucketKey);
                    // If there is data map it to include some easy access values
                    if (r.count > 0) {
    ...
    buildResults(options = {}) {
        ...
        if (options && options.results) {
            options.results.forEach((r) => {
                let bucket = this.buckets.find((b) => b.name === r.key);
...
// Module
var code = "<div class=\"needletail-grouped-search-bar-result-title\"> {{key}} </div> <div class=\"needletail-grouped-search-bar-result-results\"> {{#results}} <div class=\"needletail-grouped-search-bar-result\" data-attribute=\"{{raw}}\"> {{{title}}} <hr> {{{highlight}}} </div> {{/results}} </div>";
// Exports
module.exports = code;
...
const BaseClasses_1 = __webpack_require__(0);
const result_html_1 = __importDefault(__webpack_require__(46));
const result_results_html_1 = __importDefault(__webpack_require__(47));
const mustache_1 = __importDefault(__webpack_require__(1));
const Helpers_1 = __webpack_require__(2);
const debounce_1 = __importDefault(__webpack_require__(3));
    ...
    executeJS() {
        ...
        document.addEventListener(Helpers_1.Events.onResultRequest, debounce_1.default((e) => __awaiter(this, void 0, void 0, function* () {
            ...
            let result = yield this.client.search({
                ...
                search: Object.assign({ "should": Object.assign({}, e.detail.search_values) }, e.detail.extra_search_values),
                size: this.per_page,
...
const BaseClasses_1 = __webpack_require__(0);
const aggregation_bar_html_1 = __importDefault(__webpack_require__(49));
const clear_filters_html_1 = __importDefault(__webpack_require__(50));
const mustache_1 = __importDefault(__webpack_require__(1));
const Helpers_1 = __webpack_require__(2);
