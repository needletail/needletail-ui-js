...
// Module
var code = "<div class=\"needletail-aggregation needletail-aggregation-slider needletail-aggregation-slider-{{classTitle}} {{collapsible}} {{collapsed}}\"> <div class=\"needletail-aggregation-slider-title\"> {{title}} </div> <div class=\"needletail-collapsible-container\"> <div class=\"needletail-aggregation-slider-container__range\"> {{#inputs_top}} <div class=\"needletail-aggregation-slider-inputs top\"> <input type=\"number\" class=\"needletail-aggregation-slider-input-min {{display_only}}\"> <input type=\"number\" class=\"needletail-aggregation-slider-input-max {{display_only}}\"> </div> {{/inputs_top}} <div class=\"needletail-aggregation-slider-range-container\"> <div class=\"needletail-aggregation-slider-range\"> <div class=\"needletail-aggregation-slider-range-left\"></div> <div class=\"needletail-aggregation-slider-range-divider\"></div> <div class=\"needletail-aggregation-slider-range-right\"></div> </div> </div> {{#inputs_bottom}} <div class=\"needletail-aggregation-slider-inputs bottom\"> <input type=\"number\" class=\"needletail-aggregation-slider-input-min {{display_only}}\"> <input type=\"number\" class=\"needletail-aggregation-slider-input-max {{display_only}}\"> </div> {{/inputs_bottom}} </div> </div> </div>";
// Exports
module.exports = code;
...
class AutocompleteBar extends BaseClasses_1.Widget {
    constructor(options = {}) {
        ...
        this.setSortDirection(Helpers_1.optional(options.search).direction || this.getSortDirection());
        this.setSortMode(Helpers_1.optional(options.search).mode || this.getSortMode());
        ...
        document.addEventListener(Helpers_1.Events.onGroupedSearch, (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result && result.data) {
                ...
                Object.keys(result.data).forEach((bucketKey) => {
                    ...
                    const bucket = this.getBuckets().find((b) => b.name === bucketKey);
                    // If there is data map it to include some easy access values
                    if (r.count > 0) {
    ...
    buildResults(options = {}) {
        ...
        if (options && options.results) {
            options.results.forEach((r) => {
                const bucket = this.getBuckets().find((b) => b.name === r.key);
...
class Result extends BaseClasses_1.Widget {
    ...
    render(results = [], pages = []) {
        ...
        if (this.getShowQuickPagination()) {
            ...
            options.firstPage = 1;
            options.lastPage = Helpers_1.optional(lastPage).page;
        }
        const rendered = mustache_1.default.render(template, options);
        return document.createRange().createContextualFragment(rendered);
    }
    ...
    executeJS() {
        ...
        document.addEventListener(Helpers_1.Events.onResultRequest, debounce_1.default((e) => __awaiter(this, void 0, void 0, function* () {
            ...
            let currentPage = parseInt(Helpers_1.URIHelper.getSearchParam('page')) || 1;
            // Perform the search
            const result = yield this.client.search({
