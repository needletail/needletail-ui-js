...
class Result extends BaseClasses_1.Widget {
    constructor(options = {}) {
        ...
        this.totalResults = 0;
        this.totalResultsText = 'Total results';
        this.setQuery(options.query || this.getQuery());
